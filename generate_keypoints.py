...
parser.add_argument('--video', type=str, help='video file to run pose model on')
parser.add_argument('--model', type=int, default=101)
parser.add_argument('--cam_id', type=int, default=0)
parser.add_argument('--cam_width', type=int, default=1280)
parser.add_argument('--cam_height', type=int, default=720)
parser.add_argument('--scale_factor', type=float, default=0.7125)
parser.add_argument('--title', type=str, default=None, help="Optionally use a video file instead of a live camera")
...
def main():
    ...
    with tf.Session() as sess:
        ...
        csv_file = f'keypoint_files/patient_1/{args.title}_df.csv'
